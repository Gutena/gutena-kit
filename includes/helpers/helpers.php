...
//Get global typography class
if ( ! function_exists( 'get_gutena_kit_global_typography_class' ) ) {
	function get_gutena_kit_global_typography_class( $slug ){
		//get global typography
		get_gutena_kit_global_typography();
		...
		return ( ! empty( $gutena_kit_global_typography[ $slug ]['fluidTypography'] ) && '1' == $gutena_kit_global_typography[ $slug ]['fluidTypography'] ) ? 'has-gutenakit-f-typography' : '' ;
	}
}
...
if ( ! function_exists( 'gutenakit_block_additional_controls_css' ) ) {
	function gutenakit_block_additional_controls_css( $editor = false ){
		...
		".( $editor ? " .editor-styles-wrapper .block-editor-block-list__layout.is-root-container .has-gutenakit-margin-default ," : "").".has-gutenakit-margin-default{
